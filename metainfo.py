...
if __name__ == '__main__':
    preprocessed_metainfo = self_defined_load_file(root, dataset, istrain=istrain, meta_info=meta_info)
    # print(preprocessed_metainfo)
    if meta_info:
        meta_txt = ''
    else:
        meta_txt = "_withoutmeta"
    if istrain:
        f = open(save_pickle_path + 'train_' + 'metainfo' + revised_txt + meta_txt + '.pkl', 'wb')       
    else:
        f = open(save_pickle_path + 'val_' + 'metainfo' + revised_txt + meta_txt + '.pkl', 'wb')
